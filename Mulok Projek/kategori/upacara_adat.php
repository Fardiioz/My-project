...
$category_name = 'Upacara Adat';
$table_name = 'kategori_upacara_adat';
    ...
    if (isset($_POST['action'])) {
        ...
        if ($action == 'create') {
            ...
            if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                $upload_dir = '../uploads/upacara_adat/';
                ...
                if (move_uploaded_file($_FILES['image']['tmp_name'], $image_path)) {
                    $image = 'uploads/upacara_adat/' . $image_name;
                }
            }

            $query = "INSERT INTO $table_name (nama, deskripsi, image) VALUES ('$nama', '$deskripsi', '$image')";
            if (mysqli_query($conn, $query)) {
                $message = "Data upacara adat berhasil ditambahkan!";
            ...
            if (mysqli_query($conn, $query)) {
                $message = "Data upacara adat berhasil diupdate!";
                $message_type = 'success';
            } else {
                $message = "Error: " . mysqli_error($conn);
                $message_type = 'error';
            ...
            if (mysqli_query($conn, $query)) {
                $message = "Data upacara adat berhasil dihapus!";
                $message_type = 'success';
            } else {
                $message = "Error: " . mysqli_error($conn);
                $message_type = 'error';
