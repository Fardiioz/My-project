...
$category_name = 'Lagu Tradisional';
$table_name = 'kategori_lagu_tradisional';
    ...
    if (isset($_POST['action'])) {
        ...
        if ($action == 'create') {
            ...
            if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                $upload_dir = '../uploads/lagu_tradisional/';
                ...
                if (move_uploaded_file($_FILES['image']['tmp_name'], $image_path)) {
                    $image = 'uploads/lagu_tradisional/' . $image_name;
                }
            }

            $query = "INSERT INTO $table_name (nama, deskripsi, image) VALUES ('$nama', '$deskripsi', '$image')";
            if (mysqli_query($conn, $query)) {
                $message = "Data lagu tradisional berhasil ditambahkan!";
            ...
            if (mysqli_query($conn, $query)) {
                $message = "Data lagu tradisional berhasil diupdate!";
                $message_type = 'success';
            } else {
                $message = "Error: " . mysqli_error($conn);
                $message_type = 'error';
            ...
            if (mysqli_query($conn, $query)) {
                $message = "Data lagu tradisional berhasil dihapus!";
                $message_type = 'success';
            } else {
                $message = "Error: " . mysqli_error($conn);
                $message_type = 'error';
