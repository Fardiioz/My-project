...
$category_name = 'Tarian Adat';
$table_name = 'kategori_tarian_adat';
    ...
    if (isset($_POST['action'])) {
        ...
        if ($action == 'create') {
            ...
            if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                $upload_dir = '../uploads/tarian_adat/';
            ...
            if (mysqli_query($conn, $query)) {
                $message = "Data tarian adat berhasil diupdate!";
                $message_type = 'success';
            } else {
                $message = "Error: " . mysqli_error($conn);
                $message_type = 'error';
            ...
            if (mysqli_query($conn, $query)) {
                $message = "Data tarian adat berhasil dihapus!";
                $message_type = 'success';
            } else {
                $message = "Error: " . mysqli_error($conn);
                $message_type = 'error';
